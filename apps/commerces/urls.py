...
from . import views
from apps.avis import views as v
...
urlpatterns = [
    ...
    # Mise à jour
    path(
        "<int:id>/update/", views.CommerceUpdateView.as_view(), name="commerce-update"
    ),
    # Suppression (soft delete)
    path(
        "<int:id>/delete/", views.CommerceDeleteView.as_view(), name="commerce-delete"
    ),
    # =========================================================
    # 🗺️ MAP / GEO
    # =========================================================
    ...
    path(
        "by-category/",
        views.CommerceByCategoryView.as_view(),
        name="commerce-by-category",
    ),
    # =========================================================
    # 🏷️ CATÉGORIES
    # =========================================================
